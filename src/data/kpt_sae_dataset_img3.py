...
class eventSurfacesDataset(DatasetBase):
    ...
    def _read_dataset(self):
        ...
        for current_filename in self.data_filenames:
            ...
            kpts_name_list = os.listdir(os.path.join(self._root, current_filename, self._sae_type[0]))
    ...
    def generate_balanced_pairs(self, current_stream_num):
        ...
        anchor_class_path = os.path.join(self._root, self.data_filenames[current_stream_num], self._sae_type[0], self._kpt_names[current_stream_num][rnd_cls1])
        negative_class_path = os.path.join(self._root, self.data_filenames[current_stream_num], self._sae_type[0],self._kpt_names[current_stream_num][rnd_cls2])
        ...
        samples_list_a = [line.rstrip() for line in open(os.path.join(self._root, self.data_filenames[current_stream_num], self._sae_type[0], self._kpt_names[current_stream_num][rnd_cls1],'kpt_files.txt'))]
        ...
        subclasses_sample_n = np.load(os.path.join(self._root, self.data_filenames[current_stream_num], self._sae_type[0], self._kpt_names[current_stream_num][rnd_cls2], 'subclasses.npy'),allow_pickle=True)
        ...
        samples_list_n = [line.rstrip() for line in open(os.path.join(self._root, self.data_filenames[current_stream_num], self._sae_type[0], self._kpt_names[current_stream_num][rnd_cls2], 'kpt_files.txt'))]
        ...
        img_name_1_c_1 = os.path.join(self._root, self.data_filenames[current_stream_num], self._sae_type[0], self._kpt_names[current_stream_num][rnd_cls1], samples_list_a[rnd_subsmpl1])
        img_name_1_c_2 = os.path.join(self._root, self.data_filenames[current_stream_num], self._sae_type[1], self._kpt_names[current_stream_num][rnd_cls1], samples_list_a[rnd_subsmpl1])
        img_name_1_c_3 = os.path.join(self._root, self.data_filenames[current_stream_num], self._sae_type[2], self._kpt_names[current_stream_num][rnd_cls1], samples_list_a[rnd_subsmpl1])

        img_name_2_c_1 = os.path.join(self._root, self.data_filenames[current_stream_num], self._sae_type[0], self._kpt_names[current_stream_num][rnd_cls1], samples_list_a[rnd_subsmpl2])
        img_name_2_c_2 = os.path.join(self._root, self.data_filenames[current_stream_num], self._sae_type[1], self._kpt_names[current_stream_num][rnd_cls1], samples_list_a[rnd_subsmpl2])
        img_name_2_c_3 = os.path.join(self._root, self.data_filenames[current_stream_num], self._sae_type[2], self._kpt_names[current_stream_num][rnd_cls1], samples_list_a[rnd_subsmpl2])

        img_name_3_c_1 = os.path.join(self._root, self.data_filenames[current_stream_num], self._sae_type[0], self._kpt_names[current_stream_num][rnd_cls2], samples_list_n[rnd_subsmpl3])
        img_name_3_c_2 = os.path.join(self._root, self.data_filenames[current_stream_num], self._sae_type[1], self._kpt_names[current_stream_num][rnd_cls2], samples_list_n[rnd_subsmpl3])
        img_name_3_c_3 = os.path.join(self._root, self.data_filenames[current_stream_num], self._sae_type[2], self._kpt_names[current_stream_num][rnd_cls2], samples_list_n[rnd_subsmpl3])
        ...
        data_sample1 = np.dstack((np.load(img_name_1_c_1),np.load(img_name_1_c_2),np.load(img_name_1_c_3)))
        data_sample2 = np.dstack((np.load(img_name_2_c_1),np.load(img_name_2_c_2),np.load(img_name_2_c_3)))
        data_sample3 = np.dstack((np.load(img_name_3_c_1),np.load(img_name_3_c_2),np.load(img_name_3_c_3)))
